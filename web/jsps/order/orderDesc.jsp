    ...
    <c:choose>
        <c:when test="${orderItem.status eq 1 }">
            ...
            <c:when test="${orderItem.status eq 3 }">
                ...
                <div class="row" style="text-align: center">
                    <img src="${pageContext.request.contextPath}/images/mjfh.png">
                </div>
            </c:when>
            <c:when test="${orderItem.status eq 4 }">
                ...
                <div class="row" style="text-align: center">
                    <img src="${pageContext.request.contextPath}/images/qrsh.png">
                </div>
            </c:when>
            <c:when test="${orderItem.status eq 5 }">
                <div class="row">
                    ...
                    <div class="col-sm-1" style="margin-left: 85px">
                        <h4 style="color: #078d07">评价</h4>
                    </div>
                </div>
                <div class="row" style="text-align: center">
                    <img src="${pageContext.request.contextPath}/images/pj.png">
                </div>
            </c:when>
    </c:choose>
    <div class="row" style="margin-top: 80px">
        <div class="col-sm-4 col-sm-offset-1" style="border:1px solid #000">
            <h4>订单信息</h4>
            <hr>
        ...
        <div class="col-sm-7" style="text-align: center;border:1px solid #000;width: 600px;height: 378px;">
            <c:choose>
                ...
                <c:when test="${orderItem.status eq 4 }">
                    ...
                    <h4>您可以 &nbsp</h4>
                    <a href="<c:url value='/OrderServlet?method=updateStatus&status=5&orderItemId=${orderItem.orderItemId }'/>">
