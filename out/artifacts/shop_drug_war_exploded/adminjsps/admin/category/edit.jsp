...
<div class="col-sm-6 col-sm-offset-3" style="margin-top: 100px; border: 3px solid #D2D3D5;">
    <div style="text-align: center"><h4>修改一级分类</h4></div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input class="form-control input"
                       type="text" name="cname" id="cname" value="${parent.cname }">
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label">分类描述</label>
            <div class="col-sm-10">
                <textarea class="form-control input" type="text" name="categoryDesc" id="categoryDesc">${parent.categoryDesc }</textarea>
            </div>
        </div>
        <div class="form-group">
