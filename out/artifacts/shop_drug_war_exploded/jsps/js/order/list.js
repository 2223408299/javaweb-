...
function batchDelete() {
    ...
    location = "/shop_drug_war_exploded/OrderServlet?method=batchDelete&status=" + status + "&orderItemIds=" + orderItemIdArray;
}
...
function batchUpdate() {
    ...
    var status = $("#status").val();
    location = "/shop_drug_war_exploded/OrderServlet?method=batchUpdate&status=" + status + "&orderItemIds=" + orderItemIdArray;
}
...
function batchPayment() {
    ...
    location = "/shop_drug_war_exploded/OrderServlet?method=batchPaymentPre&orderItemIds=" + orderItemIdArray;
}