...
public class CategoryDao {
	...
	private Category toCategory(Map<String,Object> map) {
		/*
		 * map {cid:xx, cname:xx, pid:xx, drugDesc:xx, orderBy:xx}
		 * Category{cid:xx, cname:xx, parent:(cid=pid), drugDesc:xx}
		 */
	...
	public void add(Category category) throws SQLException {
		String sql = "insert into t_category(cid,cname,pid,categoryDesc) values(?,?,?,?)";
		/*
		...
		Object[] params = {category.getCid(), category.getCname(), pid, category.getCategoryDesc()};
	...
	public void edit(Category category) throws SQLException {
		String sql = "update t_category set cname=?, pid=?, categoryDesc=? where cid=?";
		String pid = null;
		if(category.getParent() != null) {
			pid = category.getParent().getCid();
		}
		Object[] params = {category.getCname(), pid, category.getCategoryDesc(), category.getCid()};
		qr.update(sql, params);
	}
